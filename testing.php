	...
	<section class="cd-hero" id="wrap">
		...
		<ul class="cd-hero-slider autoplay">
			<li class="selected" style="background-image: url('images/main.jpg')">
				<div class="cd-full-width" >
					...
					<!--<div class="container">
			<div class="first"><a class="click" href="#"><img src="images/Redarrow.gif" width="42px" height="42px" alt=""></a></div>
			</div>-->
					</div> <!-- .cd-full-width -->
		...
		<nav>
				...
				<ul>
					...
					<li><a class="click" href="#"><img src="images/logopnc1.png" width="65px" height="50px" alt="" style="margin-top:-20px"></a></li>
